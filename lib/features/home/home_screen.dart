...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: CustomScrollView(slivers: [
      ...
      SliverPadding(padding: const EdgeInsets.fromLTRB(18, 18, 18, 0), sliver: SliverToBoxAdapter(child: Container(height: 54, padding: const EdgeInsets.symmetric(horizontal: 15), decoration: BoxDecoration(color: MercDealTheme.card, borderRadius: BorderRadius.circular(19), border: Border.all(color: Colors.white.withValues(alpha: .07))), child: const Row(children: [Icon(Icons.search_rounded, color: Colors.white54), SizedBox(width: 10), Expanded(child: Text('Cerca il tuo prossimo affare...', style: TextStyle(color: const Color(0x61FFFFFF)))), Icon(Icons.mic_none_rounded, color: MercDealTheme.green)])))),
